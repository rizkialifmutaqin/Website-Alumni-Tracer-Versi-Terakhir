        ...
        try {
            ...
            if (response.data) {
                ...
                if (siswa.aktifitas_stlh_lulus === "Kuliah") {
                    history.push({
                        pathname: "/dataSiswa/tambahSiswa/tambahSiswaKuliah",
                        state: { id_siswa: response.data.id_siswa },
                    });
                } else if (siswa.aktifitas_stlh_lulus === "Kerja") {
                    history.push({
                        pathname: "/dataSiswa/tambahSiswa/tambahSiswaKerja",
                        state: { id_siswa: response.data.id_siswa },
                    });
                } else if (siswa.aktifitas_stlh_lulus === "Kuliah dan Kerja") {
                    history.push({
                        pathname: "/dataSiswa/tambahSiswa/tambahSiswaKuliahDanKerja",
                        state: { id_siswa: response.data.id_siswa },
                    });
                } else if (siswa.aktifitas_stlh_lulus === "Wirausaha") {
                    history.push({
                        pathname: "/dataSiswa/tambahSiswa/tambahSiswaWirausaha",
                        state: { id_siswa: response.data.id_siswa },
                    });
