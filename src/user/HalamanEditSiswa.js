      ...
      if (response.data) {
        ...
        if (siswa.aktifitas_stlh_lulus !== aktifitas_stlh_lulus_awal) {
          switch (siswa.aktifitas_stlh_lulus) {
            case "Kerja":
              history.push(`/halamanEditSiswa/formKerja/${siswa.id_siswa}`);
              break;
            case "Kuliah":
              history.push(`/halamanEditSiswa/formKuliah/${siswa.id_siswa}`);
              break;
            case "Kuliah dan Kerja":
              history.push(`/halamanEditSiswa/formKuliahDanKerja/${siswa.id_siswa}`);
              break;
            case "Wirausaha":
              history.push(`/halamanEditSiswa/formWirausaha/${siswa.id_siswa}`);
              break;
            default:
              history.push("/mainPage");
              break;
...
export default HalamanEditSiswa;
